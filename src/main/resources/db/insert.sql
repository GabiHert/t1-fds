...
-- Assinaturas válidas
INSERT INTO Subscription (code, startDate, endDate, clientCode, applicationCode) VALUES
...
-- Inserindo Promoções
INSERT INTO Promotion (code, discountPercentage, extraDays, monthsRequired, applicationCode) VALUES
(1, 40, 0, 12, 1),  -- Promoção de 40% de desconto para App A
(2, 0, 45, 0, 2)   -- Pague 30 e ganhe 45 dias para App B
ON CONFLICT (code) DO NOTHING;

-- Inserindo Pagamentos
INSERT INTO Payment (code, amount, paymentDate, dealCode, subscriptionCode) VALUES
